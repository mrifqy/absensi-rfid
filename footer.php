					...
					<div class="col-lg-3 col-md-6">
						<div class="">
							...
							<nav class="list-unstyled">
								...
								<li class="list-space">
									<a href="datakaryawan.php" class="list-menu">Data Karyawan</a>
								</li>
								<li class="list-space">
									<a href="absensi.php" class="list-menu">Rekapitulasi Absensi</a>
								</li>
								<li class="list-space">
									<a href="scan.php" class="list-menu">Scan Kartu</a>
								</li>
